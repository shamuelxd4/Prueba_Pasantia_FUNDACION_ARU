<!-- ============================================= -->
<!-- ============================================= -->
<!-- PRUEBA INCISO 1 DISEÑO PAGINA WEB -->
<!-- ============================================= -->
<!-- ============================================= -->
<?php
...
?>
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li"><a href="contact.php" class="tm-nav-link">Informacion Variada</a></li>
							</ul>
						</nav>	
					</div>
				</div>
...
<!-- ===================================================================================== -->
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">Bienvenido a la Pagina</h2>
				<p class="col-12 text-center">Hoy hablaremos un poco de los manejos de datos y sus maneras de como usar estas maneras.</p>
				<p class="col-12 text-center">Veremos lo muy importante que es el manejo de datos hoy en dia.</p>
			...
			<div class="tm-paging-links">
				<nav>
					<ul>
						<li class="tm-paging-item"><a href="#" class="tm-paging-link active">Online</a></li>
						<li class="tm-paging-item"><a href="#" class="tm-paging-link">Fisico</a></li>
						<li class="tm-paging-item"><a href="#" class="tm-paging-link">Sistema</a></li>
					</ul>
				</nav>
			</div>
